...
export default async function StmcUpStuPass({ action, template, execute, data, connections, contexts, id }: props<StmcUpStuPass>) {
    try {
        ...
        if (!ldap) throw new xError("Provider not connected.");
