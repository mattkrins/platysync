...
export default function Login() {
    ...
    <Container size={400} my={20}>
        ...
        <Paper className={classes.box} withBorder shadow="md" p="lg" mt="xs" radius="md">{user.username?
            <>
                <Alert variant="filled" color="cyan" icon={<IconUser/>} >Logged in as {user.username}</Alert>
                <Button onClick={()=>setLocation('/logout')} color="pink" fullWidth mt="xs">Logout</Button>
            </>:
            <>
